...
MODEL_SHA256 = os.environ.get("P09_MODEL_SHA256", "0" * 64)
P06_SHA256 = os.environ.get("P09_P06_SHA256", "0" * 64)
P07_SHA256 = os.environ.get("P09_P07_SHA256", "0" * 64)
P08_MANIFEST_SHA256 = os.environ.get("P09_P08_MANIFEST_SHA256", "0" * 64)
P08_PLANE_SHA256 = os.environ.get("P09_P08_PLANE_SHA256", "0" * 64)
